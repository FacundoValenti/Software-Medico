...
Public Class Imprimir_Agenda
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Software_Medico.Imprimir-Agenda.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedImprimir_Agenda
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Imprimir_Agenda = New Imprimir_Agenda()
        rpt.Site = Me.Site
        Return rpt
    End Function
